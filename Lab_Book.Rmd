...
I think this is because some sites have very low occupancy, which is where we draw our Ntot estimate. This then pulls the estimate down towards 0, making it very easy for the number of adults surviving to the next census to exceed the number of adults. This is, naturally, impossible. 